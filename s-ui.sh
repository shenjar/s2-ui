...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/shen-sky6/s2-ui/main/install.sh"
...
update_shell() {
    wget -O /usr/bin/s-ui -N --no-check-certificate https://github.com/shen-sky6/s2-ui/raw/main/s-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
